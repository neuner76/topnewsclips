        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-12 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-4 text-xs font-medium text-background/70">
              ...
              <Link href="/admin/pipeline" className="hover:text-background transition-colors">
                Pipeline
              </Link>
              <Link href="/admin/personalization" className="hover:text-background transition-colors">
                Personalization
              </Link>
              <Link href="/admin/submissions" className="hover:text-background transition-colors">
                Submissions
              </Link>
              <Link href="/admin/response-resources" className="hover:text-background transition-colors">
                Response
              </Link>
              <Link href="/admin/reader-questions" className="hover:text-background transition-colors">
                Questions
              </Link>
