    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="mb-10 border-b-2 border-[oklch(0.52_0.14_196)] pb-6">
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-3">Recommend a Source</h1>
        ...
        <div className="space-y-12 text-[15px] leading-relaxed">
          ...
          {/* Submission form */}
          <section>
            <h2 className="text-lg font-black tracking-tight uppercase mb-5">Submit a recommendation</h2>
            <SubmitForm />
          </section>
          ...
          {/* Review rules */}
          <section className="p-5 bg-muted/50 border border-border rounded-lg text-sm text-muted-foreground space-y-2">
          ...
          {/* Public review log */}
          <section>
            <h2 className="text-lg font-black tracking-tight uppercase mb-2">Review log</h2>
            ...
            {log.length === 0 ? (
              ...
              <div className="space-y-4">
                {log.map((s) => (
                  <div key={s.id} className="border border-border rounded-lg p-4 text-sm">
