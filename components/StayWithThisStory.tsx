...
export default function StayWithThisStory({ story, resources = [] }: {
  ...
  return (
    <SectionCard accent="#0F766E" className="mb-4">
      <TrackEvent
      ...
      />
      <div className="mb-4">
        <p className="text-[11px] font-bold tracking-[0.15em] uppercase text-[#0F766E] mb-1">Stay with this story</p>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {allowed.has('learn') && (
          <div className="rounded-xl border border-[#CBD5E1] bg-white p-3 hover:bg-[#EFF6FF] transition-colors">
            <p className="text-sm font-bold text-[#1F2937] mb-1">Learn</p>
            <p className="text-xs text-[#64748B] mb-2">Read the primary source or background context before reacting.</p>
            {primarySource ? (
        ...
        {allowed.has('track') && (
          <div className="rounded-xl border border-[#CBD5E1] bg-white p-3 hover:bg-[#EFF6FF] transition-colors">
            <p className="text-sm font-bold text-[#1F2937] mb-1">Track</p>
            <p className="text-xs text-[#64748B] mb-2">Follow updates as this story develops.</p>
        ...
        {allowed.has('share_responsibly') && (
          <div className="rounded-xl border border-[#CBD5E1] bg-white p-3 hover:bg-[#EFF6FF] transition-colors">
            <p className="text-sm font-bold text-[#1F2937] mb-1">Share responsibly</p>
            <p className="text-xs text-[#64748B]">
        ...
        {resources.map(resource => (
          <div key={resource.id} className="rounded-xl border border-[#CBD5E1] bg-white p-3 hover:bg-[#EFF6FF] transition-colors">
            <p className="text-sm font-bold text-[#1F2937] mb-1">{resource.title}</p>
            <p className="text-xs text-[#64748B] mb-2">{resource.description}</p>
      ...
      <div className="mt-4 rounded-xl border border-[#CBD5E1] bg-white p-3 hover:bg-[#EFF6FF] transition-colors">
        <ReaderQuestionBox
