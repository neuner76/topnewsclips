...
Respond with this exact JSON structure:
{
  ...
  "summary": "2 short sentences — maximum 25 words each — written for a citizen who distrusts institutional spin. Do not reproduce the source's framing — reconstruct the story from the facts in the description. Sentence 1: state exactly what happened, who did it, and who was affected — use specific names, places, and numbers. Sentence 2: explain what this means for ordinary people's rights, safety, money, or accountability over powerful institutions. CRITICAL RULES: (1) Never editorialize or use politically charged descriptors — do not characterize events as 'authoritarian', 'fascist', 'extremist', 'radical', 'dangerous', 'alarming', or any other loaded political label. State facts only. (2) Never use: 'highlights the risks of', 'raises questions about', 'sparks debate', 'draws attention to', 'allegedly', 'reportedly', 'is said to', or any phrase that softens facts for the powerful. (3) The summary must be informative to a citizen regardless of their political affiliation — if it only validates one political tribe's worldview, rewrite it neutrally.",
