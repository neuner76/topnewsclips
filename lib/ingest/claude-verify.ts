...
Respond with this exact JSON structure:
{
  ...
  "headline": "Compelling 10-15 word headline written for the reader — lead with the most newsworthy fact and why it matters. Never start with the journalist's name or 'Trusted Journalist'. No passive constructions. Make the reader feel the stakes.",
  "summary": "2 sentences written for a curious citizen who wants to understand what's happening. Sentence 1: what specifically happened, where, and who is affected — name the people, institution, or place involved. Sentence 2: why this matters to ordinary people — what it means for their safety, rights, money, or accountability over powerful institutions. Never use vague phrases like 'highlights the risks of', 'raises questions about', 'sparks debate', or 'draws attention to' — tell the reader directly what is at stake.",
