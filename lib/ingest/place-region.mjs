...
export const PLACE_REGION = {
  ...
  // US states (domestic → null). Correct a US-subject story from a foreign outlet
  // (region follows the OUTLET's home country) back to domestic when it names a
  // state. 'georgia' is deliberately omitted (ambiguous with the country); cities
  // are omitted to avoid collisions (e.g. 'athens' is already Greece).
  'alabama': null, 'alaska': null, 'arizona': null, 'arkansas': null, 'colorado': null,
  'connecticut': null, 'delaware': null, 'hawaii': null, 'idaho': null, 'illinois': null,
  'indiana': null, 'iowa': null, 'kansas': null, 'kentucky': null, 'louisiana': null,
  'maine': null, 'maryland': null, 'massachusetts': null, 'michigan': null, 'minnesota': null,
  'mississippi': null, 'montana': null, 'nebraska': null, 'nevada': null, 'new hampshire': null,
  'new jersey': null, 'new mexico': null, 'north carolina': null, 'north dakota': null, 'ohio': null,
  'oklahoma': null, 'oregon': null, 'pennsylvania': null, 'rhode island': null, 'south carolina': null,
  'south dakota': null, 'tennessee': null, 'utah': null, 'vermont': null, 'virginia': null,
  'west virginia': null, 'wisconsin': null, 'wyoming': null,

  // ── Continent / region-level names ──────────────────────────────────────
  // Stories written at the continent level ("flash floods across Europe", "leave
  // the Middle East") name no specific country, so without these they had no anchor
  // — the reconcile kept a possibly-wrong tag and the live-QC region check false-
  // positived. Bare 'asia' is omitted (no single system bucket — South Asia/Korea/
  // Japan are tagged separately); 'african' is omitted (false-matches "African
  // American"), same caution as 'america'/'american' above.
  'europe': 'Europe', 'european': 'Europe',
  'middle east': 'Middle East', 'middle eastern': 'Middle East', 'mideast': 'Middle East',
  'africa': 'Africa',
